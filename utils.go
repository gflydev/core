...
//
// Parameters:
//   - path: The input string representing the route path.
//
// Returns:
//   - The sanitized path with the trailing '.' removed if present.
func cleanPath(path string) string {
	return strings.TrimSuffix(path, ".")
}

// validatePath validates the provided path before adding it to the router.
//
// Parameters:
//   - path: The input string representing the route path.
//
// Panics:
//   - If the path is empty or does not start with a '/'.
...
// getOptionalPaths returns all possible paths when the original path has optional arguments.
//
// Parameters:
//   - path: The input string representing the route path with optional parameters.
//
// Returns:
//   - A slice of strings containing all possible paths generated by resolving optional arguments.
