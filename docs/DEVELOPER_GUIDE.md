...
The gFly Core framework uses environment variables for configuration. For a comprehensive list of all environment variables used by the framework, see [ENVIRONMENT_VARIABLES.md](ENVIRONMENT_VARIABLES.md).
